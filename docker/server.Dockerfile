...
ARG AGENT_REGISTRY_KEYCLOAK_URL
ARG AGENT_REGISTRY_KEYCLOAK_REALM
ARG AGENT_REGISTRY_KEYCLOAK_CLIENT_ID
ENV NEXT_PUBLIC_KEYCLOAK_URL=${AGENT_REGISTRY_KEYCLOAK_URL}
ENV NEXT_PUBLIC_KEYCLOAK_REALM=${AGENT_REGISTRY_KEYCLOAK_REALM}
ENV NEXT_PUBLIC_KEYCLOAK_CLIENT_ID=${AGENT_REGISTRY_KEYCLOAK_CLIENT_ID}
